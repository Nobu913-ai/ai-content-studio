...
export const channels = {
  ...
  "takeout-gourmet": {
    name: "Nobuグルメ",
    displayName: "Nobuグルメ｜テイクアウトとデリバリーの選び方",
    handle: "@nobu.913",
    language: "ja",
    description:
      "外食もいいけど、テイクアウトもいい。次のごはんが少し楽しみになる、注文前グルメメモ。",
    target:
      "20〜40代、東京中心、テイクアウト・デリバリーをよく使う会社員・一人暮らし・在宅勤務者。Instagram でグルメ情報を見る層",
    tone:
      "warm-friendly。やさしく実用的、共感ベース。煽らない。店舗批判・地雷店認定NG。「絶対」「必ず」等の強い表現を避け、『個人的に』『傾向として』等の柔らかい表現を使う。",
    videoStyle:
      "顔出しなし + AIナレーション + 大きめ字幕 + スマホUI風 + 暖色トーンのグラフィック。実在店舗・実在アプリ画面を連想させないこと。",
    estimatedCPM: "—（Instagram Reels が主戦場、PR案件・アフィリエイト収益が主）",
    uploadFrequency: "1-3 videos/week",
    videoLength: { min: 20, max: 30, unit: "seconds" },
    categories: [
      {
        id: "pre-order-check",
        name: "注文前チェック",
        topics: [
          {
            title: "Uber Eatsで失敗しない店選び3つの見方",
            keywords: ["Uber Eats", "デリバリー 店選び", "失敗しない"],
          },
          {
            title: "評価4.5なのに微妙な店、ここを見落としがち",
            keywords: ["デリバリー 評価", "口コミ 見方", "高評価 微妙"],
          },
          {
            title: "メニュー写真で見抜く注意ポイント",
            keywords: ["メニュー写真", "デリバリー 注意", "失敗回避"],
          },
          {
            title: "口コミを見るとき、星より大事なところ",
            keywords: ["口コミ 見方", "レビュー チェック", "デリバリー"],
          },
          {
            title: "配達時間が長いと危ないメニュー",
            keywords: ["配達時間", "デリバリー 注意", "メニュー選び"],
          },
        ],
      },
      {
        ...
        topics: [
          {
            title: "テイクアウト向きの料理5選",
            keywords: ["テイクアウト 向き", "おすすめ", "持ち帰り"],
          },
          {
            title: "デリバリーで頼むと味が落ちやすい料理3選",
            keywords: ["デリバリー 味落ち", "向かない料理", "テイクアウト"],
          },
          {
            title: "麺類をテイクアウトするときの注意点",
            keywords: ["麺類 テイクアウト", "デリバリー 麺", "注意点"],
          },
          {
            title: "カレーがテイクアウトに強い理由",
            keywords: ["カレー テイクアウト", "持ち帰り 向き", "温め直し"],
          },
          {
            title: "サラダ系で失敗しない選び方",
            keywords: ["サラダ デリバリー", "テイクアウト サラダ", "ヘルシー"],
          },
        ],
      },
      {
        ...
        topics: [
          {
            title: "届いたら冷めていたときの対処法",
            keywords: ["デリバリー 冷めた", "テイクアウト 対処", "温め直し"],
          },
          {
            title: "写真より小さく感じたときの考え方",
            keywords: ["デリバリー 小さい", "量 少ない", "対処"],
          },
          {
            title: "ソースが片寄っていたとき",
            keywords: ["デリバリー ソース", "片寄り", "あるある"],
          },
          {
            title: "配達時間が延びたときの選択肢",
            keywords: ["配達遅延", "デリバリー 遅い", "対処"],
          },
          {
            title: "会社帰りに外しにくいテイクアウトTOP5",
            keywords: ["会社帰り", "夜ごはん", "テイクアウト おすすめ"],
          },
          {
            title: "一人暮らし向けデリバリーの選び方",
            keywords: ["一人暮らし デリバリー", "コスパ", "おすすめ"],
          },
        ],
      },
      {
        id: "concept-lifestyle",
        name: "コンセプト・生活提案",
        topics: [
          {
            title: "テイクアウトグルメ、甘く見てない？",
            keywords: ["テイクアウト 魅力", "デリバリー 楽しみ方", "コンセプト"],
          },
          {
            title: "疲れた夜にテイクアウトがありがたい理由",
            keywords: ["疲れた夜", "テイクアウト", "共感"],
          },
          {
            title: "雨の日に頼みたいデリバリー",
            keywords: ["雨の日", "デリバリー", "おすすめ"],
          },
          {
            title: "在宅勤務ランチで失敗しにくい選び方",
            keywords: ["在宅勤務 ランチ", "デリバリー", "失敗しない"],
          },
        ],
      },
    ],
    ...
    contentWarning:
      "店舗批判・地雷店認定に見える表現は厳禁。実在店名・実在デリバリーアプリ画面・実在ロゴをAI画像で生成しない。実体験ベース・やさしいアドバイス系トーンを維持。",
  },
