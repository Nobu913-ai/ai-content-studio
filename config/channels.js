...
export const channels = {
  "japanese-mindset": {
    ...
    target: "English-speaking audience interested in self-improvement, productivity, and Japanese culture (25-45 age group)",
    ...
    categories: [
      {
        ...
        topics: [
          { title: "Ikigai — Finding Your Reason to Live", keywords: ["ikigai", "japanese purpose", "meaning of life japan"] },
          { title: "Wabi-Sabi — The Beauty of Imperfection", keywords: ["wabi sabi", "japanese aesthetics", "imperfection philosophy"] },
          { title: "Mono no Aware — The Gentle Sadness of Things", keywords: ["mono no aware", "japanese emotions", "cherry blossom philosophy"] },
          { title: "Mushin — The Mind Without Mind", keywords: ["mushin", "zen mind", "flow state japan"] },
          { title: "Shoganai — The Power of Letting Go", keywords: ["shoganai", "japanese acceptance", "letting go philosophy"] },
          { title: "Kintsugi — Turning Brokenness Into Gold", keywords: ["kintsugi", "japanese repair", "resilience philosophy"] },
        ],
      },
      {
        id: "work-ethic",
        ...
        topics: [
          { title: "Kaizen — Why 1% Daily Improvement Changes Everything", keywords: ["kaizen", "continuous improvement", "japanese productivity"] },
          { title: "Gaman — The Japanese Art of Enduring the Unbearable", keywords: ["gaman", "japanese perseverance", "mental toughness japan"] },
          { title: "Omotenashi — The Mindset Behind World-Class Japanese Service", keywords: ["omotenashi", "japanese hospitality", "customer service japan"] },
          { title: "Monozukuri — Why Japan Obsesses Over Craftsmanship", keywords: ["monozukuri", "japanese craftsmanship", "manufacturing philosophy"] },
          { title: "Nemawashi — How Japanese Teams Make Decisions Without Conflict", keywords: ["nemawashi", "japanese decision making", "consensus building"] },
        ],
      },
      {
        id: "daily-life",
        ...
        topics: [
          { title: "Why Japanese Homes Are So Minimalist — It's a Philosophy", keywords: ["japanese minimalism", "japanese home", "less is more japan"] },
          { title: "Mottainai — The Mindset That Could Save the Planet", keywords: ["mottainai", "japanese waste", "sustainability japan"] },
          { title: "Hara Hachi Bu — Why Japanese People Stop Eating at 80% Full", keywords: ["hara hachi bu", "japanese diet", "longevity japan"] },
          { title: "How Japan Thinks About Silence Differently", keywords: ["japanese silence", "ma concept", "japanese communication"] },
          { title: "Shinrin-yoku — The Science Behind Japanese Forest Bathing", keywords: ["shinrin yoku", "forest bathing", "japanese nature therapy"] },
        ],
      },
    ],
    seoTags: ["japanese philosophy", "japanese mindset", "self improvement", "ikigai", "wabi sabi", "japanese culture", "life lessons from japan", "zen philosophy"],
  },
    ...
    categories: [
      {
        ...
        topics: [
          ...
          { title: "S&P500 vs オルカン、結局どっちがいいの？", keywords: ["S&P500", "オルカン", "インデックス投資 比較"] },
  ...
  "chill-culture": {
    ...
    categories: [
      {
        ...
        name: "シーシャ・カフェ",
        topics: [
          { title: "初めてのシーシャカフェ — 入り方から楽しみ方まで", keywords: ["シーシャ 初心者", "水タバコ", "シーシャカフェ"] },
          { title: "東京のチルすぎるシーシャスポット5選", keywords: ["シーシャ 東京", "おすすめ", "カフェ"] },
          { title: "シーシャのフレーバー選び完全ガイド", keywords: ["シーシャ フレーバー", "おすすめ", "味"] },
          { title: "作業が捗るカフェの選び方 — Wi-Fi・電源・雰囲気", keywords: ["作業カフェ", "ノマド", "Wi-Fi カフェ"] },
        ],
      },
      {
        id: "sauna-wellness",
        ...
        topics: [
          ...
          { title: "初心者向けサウナの入り方 — 整うための3ステップ", keywords: ["サウナ 初心者", "入り方", "サウナ 始め方"] },
      ...
      },
      {
        ...
        topics: [
          ...
          { title: "Z世代のサードプレイス図鑑 — 家でも職場でもない場所", keywords: ["サードプレイス", "居場所", "Z世代"] },
    ...
    contentWarning: "シーシャ関連コンテンツは「空間体験」にフォーカスし、喫煙の推奨と取られない表現を使用すること。YouTubeのタバコ関連ポリシーに注意。",
  },
};
